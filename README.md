...
in-house Alpine 3.23 base image with kubectl and other tools included.
...
| TWO         | image-environment-base-alpine-3-23   | 2            | 1.32         |
| Full result | image-environment-deploy-alpine-3-23 | 5            | 1.0.0.1.32.X |

Output version format: `<kaptainDeployScripts>.<alpineBaseImage>.<increment>`

Example: `1.0.0.1.32.1` means:
- kaptain-deploy-scripts 1.0.0
- image-environment-base-alpine-3-23 1.32.X with matching 1.32.Y kubectl inside
...
- `image-environment-base-alpine-3-23:X.Y.Z` - base image version
